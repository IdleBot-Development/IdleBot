...
public class InventoryFull implements IdleCheck {
    ...
    public void check(Player player) {
        if (player.getInventory().firstEmpty() < 0 && !IdleBot.getPlugin().getEventManager().inventoryFullPlayers.containsKey(player)) {
            ...
            IdleBot.getPlugin().getEventManager().inventoryFullPlayers.put(player, 0);
        }
    }
}
